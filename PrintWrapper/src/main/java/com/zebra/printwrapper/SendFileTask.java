...
public class SendFileTask extends AsyncTask<Void, Boolean, Boolean> {
     ...
     * @param printer
     */
    public SendFileTask(String filePath, DiscoveredPrinter printer, SendPDFTaskCallback callback) {
    ...
    private void sendPrint() {
        ...
        if (filePath == null)
        {
            if(callback != null)
            {
                callback.onError(SendFileTaskErrors.EMPTY_PDF_FILE_PATH, "Empty PDF file path");
            }
            return;
        }
