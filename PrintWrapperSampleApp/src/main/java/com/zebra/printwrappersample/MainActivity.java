...
public class MainActivity extends AppCompatActivity {
    ...
    {
        DirectIPNetworkPrinterDiscovery discovery = new DirectIPNetworkPrinterDiscovery("192.168.251.6", this, new PrinterDiscoveryCallback() {
            @Override
            ...
            public void onDiscoveryFinished(List<DiscoveredPrinter> printerList) {
                if(printerList.size() > 0) {
                    ...
                    new SendPDFTask("/sdcard/Download/eti_chaussea.pdf", printer, callback).execute();
                }
            }
